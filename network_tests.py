...
def jacobian_test_w1_resnet(X_train, y_train):
    softmax_in = 2
    softmax_out = 5
    hidden_units = 10
    model = models.MyNeuralNetwork()
    ...
    for epss in eps:
        ...
        probabilities_grad = model_grad.forward(x_data)
        model2 = copy.deepcopy(model)
        model2.graph[0].weights1.data += d*epss
        probabilities_grad2 = model2.forward(x_data)
    ...
    for epss in eps:
        ...
        f_x_eps_d = model2.graph[1].activation_output
        f_x = model_grad.graph[1].activation_output
        grad = model_grad.graph[0].weights1.grad
        JacMV = epss * np.matmul(d.T, grad)
        diff = LA.norm(f_x_eps_d - f_x - JacMV)
        new_grad.append(diff*epss)
    ...
    plt.plot(x, new_grad, label='first order')
    plt.legend()
    plt.title('Jacobian test ResNet for w1')
    plt.ylabel('error')
    plt.xlabel('k')
    plt.semilogy([1, 2, 3, 4, 5, 6, 7, 8], grad_diff)
    plt.show()
...
def jacobian_test_w2_resnet(X_train, y_train):
    softmax_in = 2
    softmax_out = 5
    hidden_units = 10
    model = models.MyNeuralNetwork()
    ...
    for epss in eps:
        ...
        probabilities_grad = model_grad.forward(x_data)
        model2 = copy.deepcopy(model)
        model2.graph[0].weights2.data += d*epss
        probabilities_grad2 = model2.forward(x_data)
    ...
    for epss in eps:
        ...
        f_x_eps_d = model2.graph[1].activation_output
        f_x = model_grad.graph[1].activation_output
        grad = model_grad.graph[0].weights2.grad
        JacMV = epss * np.matmul(d.T, grad)
        diff = LA.norm(f_x_eps_d - f_x - JacMV)
        new_grad.append(diff*epss)
    ...
    plt.plot(x, new_grad, label='first order')
    plt.legend()
    plt.title('Jacobian test ResNet for w2')
    plt.ylabel('error')
    plt.xlabel('k')
    plt.semilogy([1, 2, 3, 4, 5, 6, 7, 8], grad_diff)
    plt.show()
...
def jacobian_test_b1_resnet(X_train, y_train):
    softmax_in = 2
    softmax_out = 5
    hidden_units = 10
    model = models.MyNeuralNetwork()
    ...
    for epss in eps:
        ...
        probabilities_grad = model_grad.forward(x_data)
        model2 = copy.deepcopy(model)
        model2.graph[0].bias1.data += d*epss
        probabilities_grad2 = model2.forward(x_data)
    ...
    for epss in eps:
        ...
        f_x_eps_d = model2.graph[1].activation_output
        f_x = model_grad.graph[1].activation_output
        grad = model_grad.graph[0].bias1.grad
        JacMV = epss * np.matmul(d.T, grad)
        diff = LA.norm(f_x_eps_d - f_x - JacMV)
        new_grad.append(diff*epss)
    ...
    plt.plot(x, new_grad, label='first order')
    plt.legend()
    plt.title('Jacobian test ResNet for bias1')
    plt.ylabel('error')
    plt.xlabel('k')
    plt.semilogy([1, 2, 3, 4, 5, 6, 7, 8], grad_diff)
    plt.show()
...
def jacobian_test_b2_resnet(X_train, y_train):
    softmax_in = 2
    softmax_out = 5
    hidden_units = 10
    model = models.MyNeuralNetwork()
    ...
    for epss in eps:
        ...
        probabilities_grad = model_grad.forward(x_data)
        model2 = copy.deepcopy(model)
        model2.graph[0].bias2.data += d*epss
        probabilities_grad2 = model2.forward(x_data)
    ...
    for epss in eps:
        ...
        f_x_eps_d = model2.graph[1].activation_output
        f_x = model_grad.graph[1].activation_output
        grad = model_grad.graph[0].bias2.grad
        JacMV = epss * np.matmul(d.T, grad)
        diff = LA.norm(f_x_eps_d - f_x - JacMV)
        new_grad.append(diff*epss)
    ...
    plt.plot(x, new_grad, label='first order')
    plt.legend()
    plt.title('Jacobian test ResNet for bias2')
    plt.ylabel('error')
    plt.xlabel('k')
    plt.semilogy([1, 2, 3, 4, 5, 6, 7, 8], grad_diff)
    plt.show()
...
def grad_test_whole_network_w(X_train, y_train, layer_number=1):
    softmax_in = 2
    softmax_out = 5
    hidden_units = 5
    model = models.MyNeuralNetwork()
    ...
    for i in range(layer_number-1):
        model.add(layers.Linear(hidden_units, hidden_units))
        model.add(activations.Tanh())
    model.add(layers.Softmax(hidden_units, softmax_out))
    model.init()
    for p in model.parameters:
...
def grad_test_whole_network_b(X_train, y_train, layer_number=1):
    softmax_in = 2
    softmax_out = 5
    hidden_units = 5
    model = models.MyNeuralNetwork()
...
def grad_test_whole_resnet_network_w(X_train, y_train, layer_number=1):
    softmax_in = 2
    softmax_out = 5
    hidden_units = 5
    model = models.MyNeuralNetwork()
    ...
    model.add(activations.Tanh())
    for i in range(layer_number-1):
        model.add(layers.ResBlock(hidden_units, hidden_units))
        model.add(activations.Tanh())
    model.add(layers.Softmax(hidden_units, softmax_out))
    model.init()
    for p in model.parameters:
    ...
    plt.plot(x, new_grad, label='first order')
    plt.legend()
    plt.title('Gradient test for the whole resnet network (weights)')
    plt.ylabel('error')
    plt.xlabel('k')
    plt.semilogy([1, 2, 3, 4, 5, 6, 7, 8], grad_diff)
    plt.show()
...
def grad_test_whole_resnet_network_b(X_train, y_train, layer_number=1):
    softmax_in = 2
    softmax_out = 5
    hidden_units = 5
    model = models.MyNeuralNetwork()
